  ...
  return (
    <div className="page-wrap expansion-page">
      ...
      <nav className="section-nav">
        ...
        <Link href="/compasses">Компас Фэн Шуй</Link>
      ...
      <section className="closing-note">
        ...
        <Link className="button primary" href="/compasses">
          Открыть компас ↗
        </Link>
      </section>
...
export function GuaPage() {
  return (
    <div className="page-wrap calculator-compact compact-tool-page">
      <div className="page-title">
        <div>
          <h1>Расчёт Гуа</h1>
          <p>Ваши направления по солнечному году рождения.</p>
        </div>
      </div>
      <GuaCalculator />
      <details className="compact-tool-help">
        <summary>Как читать направления</summary>
        <p>
          Направление — куда вы обращены лицом; сектор — часть плана дома.
          Личное Гуа не заменяет анализ помещения. Граница года — точный момент
          Ли Чунь. Если время неизвестно в день Ли Чунь, результат требует
          уточнения.
        </p>
      </details>
    </div>
