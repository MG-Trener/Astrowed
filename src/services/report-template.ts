...
export function reportHtml(chart: Chart, options: ReportOptions = {}) {
  ...
  const section = (title: string, body: string) =>
    `<section class="report-section"><div class="section-heading"><h2>${e(title)}</h2>${reportOrnament}</div>${body}</section>`;
